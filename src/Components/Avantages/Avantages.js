  ...
  return (
    <div className="flex pb-32">
      <div className="sm:px-6 lg:px-8 mx-auto py-12">
        <h2 className="text-xl sm:text-4xl sm:py-6 py-2 -mt-20 pl-2 font-bold text-left bg-gray-900 text-white w-9/12 sm:w-6/12 py-2 rounded-sm">Qu'est-ce qu'on trouve chez Zoï ?</h2>
        ...
        <div className="grid grid-cols-2 flex-shrink-0 self-center py-12"> 
            ...
            <p className="rounded-lg sm:shadow sm:absolute inset-x-1 justify-items-center sm:text-xl text-center max-w-sm sm:mt-32 my-auto mx-auto sm:px-12 px-4 bg-white text-gray-700 py-6">
        ...
        <div className="absolute max-w-7xl mx-auto sm:-mt-72 -mt-56">
          <div className="grid grid-cols-2 flex-shrink-0 self-center py-6"> 
            ...
            <p className="z-50 rounded-lg sm:shadow sm:absolute inset-x-1 justify-items-center sm:text-xl text-center max-w-sm mt-36 mx-auto sm:px-12 px-4 bg-white text-gray-700 py-6">
        ...
        <div className="grid grid-cols-2 flex-shrink-0 self-center py-6"> 
          ...
          <p className="rounded-lg sm:shadow sm:absolute inset-x-1 justify-items-center sm:text-xl text-center max-w-sm sm:mt-40 my-auto mx-auto sm:px-12 px-4 bg-white text-gray-700 py-6">
